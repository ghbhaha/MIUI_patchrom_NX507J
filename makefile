...
local-miui-removed-priv-apps :=
 ...
 local-miui-modified-apps :=  QuickSearchBox Settings MiuiHome MiuiVideo
...
#	cp other/build.prop $(ZIP_DIR)/system/build.prop
	...
	cp other/Youniyouni_130.apk $(ZIP_DIR)/data/miui/apps/

	@echo Replace framework
...
#	cp -rf other/vendor/* $(ZIP_DIR)/system/vendor/
	...
	rm -rf $(ZIP_DIR)/system/media/theme/thememanager
