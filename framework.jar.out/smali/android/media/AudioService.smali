...
.field private mNubiaVolume:Landroid/media/NubiaVolume;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1, p0}, Landroid/media/NubiaVolume;-><init>(Landroid/content/Context;Landroid/media/AudioService;)V

    iput-object v0, p0, Landroid/media/AudioService;->mNubiaVolume:Landroid/media/NubiaVolume;
...
.method static synthetic access$3900(Landroid/media/AudioService;)Landroid/media/NubiaVolume;
    .locals 1
    .parameter "x0"

    .prologue
    .line 118
    iget-object v0, p0, Landroid/media/AudioService;->mNubiaVolume:Landroid/media/NubiaVolume;
...
.method private onSetStreamVolume(IIII)V
    ...
    :cond_1
    :goto_0
    iget-object v1, p0, Landroid/media/AudioService;->mNubiaVolume:Landroid/media/NubiaVolume;

    invoke-virtual {v1, p2}, Landroid/media/NubiaVolume;->ringerModeForStreamVolume(I)I
...
.method private readPersistedSettings()V
    ...
    .line 742
    iget-object v6, p0, Landroid/media/AudioService;->mNubiaVolume:Landroid/media/NubiaVolume;

    invoke-virtual {v6}, Landroid/media/NubiaVolume;->initStateForSilentMode()V
...
.method private setRingerModeInt(IZ)V
    ...
    invoke-virtual {v0, p2, v10, p1}, Landroid/media/NubiaVolume;->updateStreamVolume(ZII)V
...
.method public adjustStreamVolume(IIILjava/lang/String;)V
    ...
    iget-object v3, v0, Landroid/media/AudioService;->mNubiaVolume:Landroid/media/NubiaVolume;

    move/from16 v0, p2

    invoke-virtual {v3, v11, v0, v15}, Landroid/media/NubiaVolume;->nbCheckForRingerModeChange(III)Z
...
.method public getStreamVolume(I)I
    ...
    .line 1320
    iget-object v2, p0, Landroid/media/AudioService;->mNubiaVolume:Landroid/media/NubiaVolume;
    ...
    invoke-virtual {v2, v3, v1}, Landroid/media/NubiaVolume;->getStreamVolume(ZI)I
...
.method public setRingerMode(I)V
    ...
    invoke-virtual {v0}, Landroid/media/NubiaVolume;->silentModeChange()Z
    ...
    invoke-virtual {v0}, Landroid/media/NubiaVolume;->updateStateWhenRingerModeChange()V
...
.method public setStreamVolumeForDevice(IIII)V
    ...
    .line 4705
    invoke-virtual {v7, p2}, Landroid/media/AudioService$VolumeStreamState;->getIndex(I)I
    ...
    .line 4718
    iget p3, p0, Landroid/media/AudioService;->mSafeMediaVolumeIndex:I
    ...
    invoke-direct {p0, v0, p3, p2}, Landroid/media/AudioService;->checkSafeMediaVolume(III)Z
    ...
    .line 4734
    invoke-direct {p0, p1, v6, p3, p4}, Landroid/media/AudioService;->sendVolumeUpdate(IIII)V
    ...
    .line 4730
    :cond_3
    invoke-direct {p0, p1, p3, p4, p2}, Landroid/media/AudioService;->onSetStreamVolume(IIII)V
