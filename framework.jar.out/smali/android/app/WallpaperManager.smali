...
.method private doBlurAndSaveWallpaper(Landroid/content/Context;Landroid/graphics/Bitmap;)V
    .locals 3
    .parameter "context"
    ...
    .line 804
    .local v0, h:I
    invoke-static {p1, p2, v1, v0}, Landroid/app/WallpaperManager;->generateBitmap(Landroid/content/Context;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;

    move-result-object v2

    .line 805
    .local v2, wallpaper:Landroid/graphics/Bitmap;
    invoke-static {p1, v2, v1, v0}, Lnubia/ui/util/BlurUtil;->asyncSaveBlurWallpaper(Landroid/content/Context;Landroid/graphics/Bitmap;II)V
...
.method private preProcess(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    .locals 13
    .parameter "source"
    ...
    const-string/jumbo v10, "preProcess old width="
    ...
    const-string/jumbo v10, "preProcess scaleX="
    ...
    const-string/jumbo v10, "preProcess new width="
...
.method private setScaledResource(I)Z
    .locals 3
    .parameter "resid"
    ...
    .line 1169
    invoke-direct {p0, v0}, Landroid/app/WallpaperManager;->setScaledStream(Ljava/io/InputStream;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private setScaledStream(Ljava/io/InputStream;)Z
    .locals 2
    .parameter "data"
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public setBitmap(Landroid/graphics/Bitmap;)V
    ...
    .line 787
    .local v4, orignWidth:I
    invoke-virtual {p1}, Landroid/graphics/Bitmap;->getHeight()I

    move-result v3

    .line 788
    .local v3, orignHeight:I
    invoke-direct {p0, p1}, Landroid/app/WallpaperManager;->preProcess(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    move-result-object v5

    .line 789
    .local v5, preBm:Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v6, v5}, Landroid/app/WallpaperManager;->doBlurAndSaveWallpaper(Landroid/content/Context;Landroid/graphics/Bitmap;)V
    :try_end_2
    ...
    .end local v3           #orignHeight:I
    .end local v4           #orignWidth:I
    .end local v5           #preBm:Landroid/graphics/Bitmap;
    :catch_0
    move-exception v6
...
.method public setResource(I)V
    ...
    .prologue
    .line 731
    invoke-direct {p0, p1}, Landroid/app/WallpaperManager;->setScaledResource(I)Z
...
.method public setStream(Ljava/io/InputStream;)V
    ...
    .prologue
    .line 826
    invoke-direct {p0, p1}, Landroid/app/WallpaperManager;->setScaledStream(Ljava/io/InputStream;)Z
